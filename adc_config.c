...
void setADC(void)
{
	PORTA.DIRSET =PIN3_bm|PIN4_bm|PIN5_bm|PIN6_bm;		// piny 3-6 PORTu A wejscia - transoptory
	PORTB.DIRSET =PIN4_bm|PIN5_bm|PIN6_bm|PIN7_bm;      // piny 4-7 PORTu B wejscia - transoptory
	...
	ADCB.INTFLAGS = ADC_CH0IF_bm; // ustawienie flagi
