...
void motorR(int16_t pulse_width)//kierowanie silnikiem prawym (-500,500)
{ 
	if(pulse_width == 0)
	{
		PORTD.OUTCLR	=	PIN5_bm;//input 1->0
	...
	TCD0.CCD		=	abs(pulse_width);
}
void motorL(int16_t pulse_width)//kierowanie silnikiem lewym (-500, 500)
{ 
	...
	{
		PORTD.OUTSET	=	PIN1_bm;//input 1->0
		PORTD.OUTCLR	=	PIN2_bm;//input 2->1
	}
	else
	{
		PORTD.OUTCLR	=	PIN1_bm;//input 1->1
		PORTD.OUTSET	=	PIN2_bm;//input 2->0
	}
	TCD0.CCA		=	abs(pulse_width);
}
void setall(void){
	// ============================		kwarc		===========================================================================================
